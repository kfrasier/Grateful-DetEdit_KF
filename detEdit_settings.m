...
filePrefix = 'GofMX_MC01_disk10'; % File name to match. 
...
% spParamsUser.tfSelect = 100; % freq used for transfer function, leave at 0 if no adjustment
...
spParamsUser.threshRL = 116; % minimum RL threshold in dB peak-to-peak
